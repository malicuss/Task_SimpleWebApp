...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductProductBody :  IEquatable<ProductProductBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductProductBody" /> class.
        /// </summary>
        ...
        public ProductProductBody(int? productId = default(int?), string productName = default(string), int? supplierId = default(int?), int? categoryId = default(int?), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), int? categoryCategoryId = default(int?), string categoryCategoryName = default(string), string categoryDescription = default(string), byte[] categoryPicture = default(byte[]), List<Product> categoryProducts = default(List<Product>), int? supplierSupplierId = default(int?), string supplierCompanyName = default(string), string supplierContactName = default(string), string supplierContactTitle = default(string), string supplierAddress = default(string), string supplierCity = default(string), string supplierRegion = default(string), string supplierPostalCode = default(string), string supplierCountry = default(string), string supplierPhone = default(string), string supplierFax = default(string), string supplierHomePage = default(string), List<Product> supplierProducts = default(List<Product>), List<OrderDetail> orderDetails = default(List<OrderDetail>), List<SelectListItem> categories = default(List<SelectListItem>), List<SelectListItem> suppliers = default(List<SelectListItem>))
        {
            ...
            if (supplierId == null)
            {
                throw new InvalidDataException("supplierId is a required property for ProductProductBody and cannot be null");
            }
            else
            {
            ...
            if (categoryId == null)
            {
                throw new InvalidDataException("categoryId is a required property for ProductProductBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("categoryCategoryId is a required property for ProductProductBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("categoryCategoryName is a required property for ProductProductBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductProductBody {\n");
        ...
        {
            return this.Equals(input as ProductProductBody);
        }

        /// <summary>
        /// Returns true if ProductProductBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductProductBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductProductBody input)
        {
            if (input == null)
                return false;
