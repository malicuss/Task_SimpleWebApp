...
{
    /// <summary>
    /// PutProductProductBody
    /// </summary>
    [DataContract]
        public partial class PutProductProductBody :  IEquatable<PutProductProductBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutProductProductBody" /> class.
        /// </summary>
        ...
        public PutProductProductBody(int? productId = default(int?), string productName = default(string), int? supplierId = default(int?), int? categoryId = default(int?), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), int? categoryCategoryId = default(int?), string categoryCategoryName = default(string), string categoryDescription = default(string), byte[] categoryPicture = default(byte[]), List<Product> categoryProducts = default(List<Product>), int? supplierSupplierId = default(int?), string supplierCompanyName = default(string), string supplierContactName = default(string), string supplierContactTitle = default(string), string supplierAddress = default(string), string supplierCity = default(string), string supplierRegion = default(string), string supplierPostalCode = default(string), string supplierCountry = default(string), string supplierPhone = default(string), string supplierFax = default(string), string supplierHomePage = default(string), List<Product> supplierProducts = default(List<Product>), List<OrderDetail> orderDetails = default(List<OrderDetail>), List<SelectListItem> categories = default(List<SelectListItem>), List<SelectListItem> suppliers = default(List<SelectListItem>))
        {
            ...
            if (supplierId == null)
            {
                throw new InvalidDataException("supplierId is a required property for PutProductProductBody and cannot be null");
            }
            else
            {
            ...
            if (categoryId == null)
            {
                throw new InvalidDataException("categoryId is a required property for PutProductProductBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("categoryCategoryId is a required property for PutProductProductBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("categoryCategoryName is a required property for PutProductProductBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutProductProductBody {\n");
        ...
        {
            return this.Equals(input as PutProductProductBody);
        }

        /// <summary>
        /// Returns true if PutProductProductBody instances are equal
        /// </summary>
        /// <param name="input">Instance of PutProductProductBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutProductProductBody input)
        {
            if (input == null)
                return false;
