...
{
    /// <summary>
    /// ApiDeleteProductBody
    /// </summary>
    [DataContract]
        public partial class ApiDeleteProductBody :  IEquatable<ApiDeleteProductBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiDeleteProductBody" /> class.
        /// </summary>
        ...
        public ApiDeleteProductBody(int? productId = default(int?), string productName = default(string), int? supplierId = default(int?), int? categoryId = default(int?), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), List<SelectListItem> categories = default(List<SelectListItem>), List<SelectListItem> suppliers = default(List<SelectListItem>))
        {
            // to ensure "productName" is required (not null)
            if (productName == null)
            {
                throw new InvalidDataException("productName is a required property for ApiDeleteProductBody and cannot be null");
            }
            else
            {
            ...
            if (supplierId == null)
            {
                throw new InvalidDataException("supplierId is a required property for ApiDeleteProductBody and cannot be null");
            }
            else
            {
            ...
            if (categoryId == null)
            {
                throw new InvalidDataException("categoryId is a required property for ApiDeleteProductBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiDeleteProductBody {\n");
        ...
        {
            return this.Equals(input as ApiDeleteProductBody);
        }

        /// <summary>
        /// Returns true if ApiDeleteProductBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiDeleteProductBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiDeleteProductBody input)
        {
            if (input == null)
                return false;
