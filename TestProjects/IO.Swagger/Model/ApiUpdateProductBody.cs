...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiUpdateProductBody :  IEquatable<ApiUpdateProductBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiUpdateProductBody" /> class.
        /// </summary>
        ...
        public ApiUpdateProductBody(int? productId = default(int?), string productName = default(string), int? supplierId = default(int?), int? categoryId = default(int?), string quantityPerUnit = default(string), double? unitPrice = default(double?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), List<SelectListItem> categories = default(List<SelectListItem>), List<SelectListItem> suppliers = default(List<SelectListItem>))
        {
            // to ensure "productName" is required (not null)
            if (productName == null)
            {
                throw new InvalidDataException("productName is a required property for ApiUpdateProductBody and cannot be null");
            }
            else
            {
            ...
            if (supplierId == null)
            {
                throw new InvalidDataException("supplierId is a required property for ApiUpdateProductBody and cannot be null");
            }
            else
            {
            ...
            if (categoryId == null)
            {
                throw new InvalidDataException("categoryId is a required property for ApiUpdateProductBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiUpdateProductBody {\n");
        ...
        {
            return this.Equals(input as ApiUpdateProductBody);
        }

        /// <summary>
        /// Returns true if ApiUpdateProductBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiUpdateProductBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiUpdateProductBody input)
        {
            if (input == null)
                return false;
